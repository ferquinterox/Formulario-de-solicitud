<html lang="es">
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script><!--pido jquery-->
  <script src="js/ajax.js"></script>
    ...
    <body>
      ...
      <header class="banner">
          <div class="container">
              <div class="row" >
                  ...
                  <p style="color:white;">Estos formularios tienen el propósito de recolectar la información sobre los distintos permisos para ser aprobados por la Autoridad del Transito y Transporte Terrestre (ATTT).</p></div>
              </div>
          </div>
      </header>
      <div class="container">
      <div class="row">
              ...
              <button class="btn btn-info" id="buscar" type="button" style="margin-top:5px; margin-left:5px;">Buscar</button>
              <button class="btn btn-danger" id="rem" type="button" style="margin-top:5px; margin-left:5px;">Regresar</button>
...
<div id="formi" style="display:none;">
    ...
    <div class="form-row">
        <!-- Bloque de nombre de proyecto -->
        <div class="form-group col-12 col-sm-12 col-md-4" id="cajas">
            <label for="nom_proy"  data-trigger="hover click" data-container="body" data-toggle="popover" data-placement="top" data-content="En este espacio van el nombre de la construccion o proyectos, donde se estará llevando a cabo la interrupción. Ejemplo: Edificios Parque del Este o Condiminios Enketo." title="Nombre del proyecto">✏ Nombre del Proyecto: ❔</label>
            <div class="large_input">
                <input class="form-control" type="text" name="nom_proy" placeholder="Introduzca el Nombre del proyecto" data-required-error="Por favor llene este campo" required tabindex="1"></div>
            <div class="help-block with-errors text-danger"></div>
        </div>
        <!-- Bloque de numero de celular -->
        <div class="form-group col-12 col-sm-12 col-md-4" id="cajas">
            <label  data-trigger="hover click" data-container="body" data-toggle="popover" data-placement="top" data-content="En este espacio va el número de celular del solicitante, este sirve como metodo para contactarlo. Ejemplo: 6300-9999." title="Número de Celular">✏ Número de Celular: ❔</label>
            <div class="large_input">
                <input class="form-control" type="text" name="num_cel" placeholder="Introduzca el numero de celular" pattern="[0-9]{4}-[0-9]{4}" data-error="Ingrese un numero de celular valido" tabindex="2"> </div>
            <div class="help-block with-errors text-danger"></div>
        </div>
        <!-- Bloque de nombre del solicitante -->
        <div class="form-group col-12 col-sm-12 col-md-4" id="cajas">
            <label  data-trigger="hover click" data-container="body" data-toggle="popover" data-placement="top" data-content="En este espacio va el nombre de la persona que en este momento estan llenando la solicitud. Ejemplo: Alan Brito." title="Nombre del Solicitante o Empresa" >✏ Nombre del Solicitante, o Empresa que solicita el permiso:* ❔</label>  
            <div class="large_input">
            <input class="form-control" type="text" name="nom_sol" placeholder="Introduzca el Nombre del solicitante o empresa" data-required-error="Por favor llene este campo" required tabindex="3">
            </div>
            <div class="help-block with-errors text-danger"></div>
        </div>
    </div>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-12 col-sm-12 col-md-4" id="cajas">
            ...
            <div class="large_input">
                <input class="form-control" type="text" name="ruc" placeholder="Introduzca el RUC de la empresa" tabindex="4"> </div>
        </div>
        ...
        <!--Bloque de numero de telefono -->
        <div class="form-group col-12 col-sm-12 col-md-4" id="cajas">
            <label  data-trigger="hover click" data-container="body" data-toggle="popover" data-placement="top" data-content="En este espacio va el teléfono fijo (local) de la empresa o del solicitante. Ejemplo: 230-1234" title="Número de Teléfono fijo">✏ Número de Teléfono fijo:* ❔</label>
            <div class="large_input">
                <input class="form-control" type="text" name="num_fijo" placeholder="Introduzca el telefono fijo" pattern="[0-9]{3}-[0-9]{4}" data-error="Ingrese un numero de telefono valido" required tabindex="6"></div>
            <div class="help-block with-errors text-danger"></div>
        </div>
    </div>
</div>
<!-- Cerrando primer contenedor -->
            <hr style="width: 90%">
            <!--Empieza el contenedor 2 -->
    ...
    <!-- Cerrando segundo contenedor -->
            
            <div class="form-row" id="cajas">
            <br> <h5>En caso de tener dias no-secuenciales, puede añadir otro día presionando el botón &darr; (Maxímo 10): </h5>
            <div class="form-row">
                ...
                <span id="cantidad_dia"> Llevas 1 día.</span> </div></div>
            </div>
            <hr style="width: 90%">
             <!--Grupo de adjunto -->
             <!--Empieza el contenedor de adjuntos 1 -->
          
           <div class="container" id="adj1">
              <div class="form-row"><h4>Adjuntos necesarios:<br><small>Aqui se deben subir los distintos adjuntos necesarios para la aprovación de la solicitud.</small></h4></div> 
              <div id="aqui"></div>
            </div>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-12 col-sm-12 col-md-12" id="cajas">
            <label data-container="body" data-trigger="hover click" data-toggle="popover" data-placement="top" data-content="En este espacio escribira el motivo de porque necesitara este permiso. Ejemplo: Necesito cerrar la vía para arreglar una fuaga debajo del pavimento." title="Motivo del permiso">✏ Motivo:* ❔</label>
             <div class="large_input">           
            <textarea class="form-control" placeholder="Especifique el motivo detallado del trabajo" form="formulario" name="motivo" rows="4" cols="50" required data-required-error="Por favor llene este campo" required tabindex="12"></textarea></div>
                 <div class="help-block with-errors text-danger"></div>
        </div>
    </div>

<!-- Cerrando tercer contenedor -->
...
<div class="container" id="all3">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-12 col-sm-12 col-md-6" id="cajas">
            ...
            <div class="large_input">
                <textarea class="form-control" placeholder="Describa de donde hasta donde se realizara el trabajo" form="formulario" name="ubicacion_esp" rows="4" cols="50" required data-required-error="Por favor llene este campo" required tabindex="13"></textarea></div>
            <div class="help-block with-errors text-danger"></div>
        </div>
    </div>
    ...
    <script async defer
                src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC0QOw7Z3wgnwgVYwjRhndk2Sn6ihzyG2s&callback=initMap">
    </script>
